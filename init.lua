...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      local open = function(win_id, custom_cfg)
        custom_cfg = custom_cfg or {}
        local config = {}
        if next(custom_cfg) ~= nil then
          config = { table.unpack(config), table.unpack(custom_cfg) }
        end

        builtin[win_id](require('telescope.themes').get_dropdown { config })
      end
